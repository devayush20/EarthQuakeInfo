...
public class EarthquakeAdapter extends ArrayAdapter<EarthquakeData> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        /*String f1=getLocation1(locationString);//location part 1
        String f2=getLocation2(locationString);//location part 2
        loc1.setText(f1);//location part 1
        loc2.setText(f2);//location part 2*/
   ...
   /* private String getLocation1(String location)
    {
        if(location.contains(" of "))
        {
            return location.substring(0,location.indexOf(" of ")+4);
        }
        else
            return "Near the";
    }
    private String getLocation2(String location)
    {
        if(!location.contains(" of "))
        {
            return location;
