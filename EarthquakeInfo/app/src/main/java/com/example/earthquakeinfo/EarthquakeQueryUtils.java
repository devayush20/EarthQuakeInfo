...
public class EarthquakeQueryUtils {
    ...
    public static ArrayList<EarthquakeData> extractEarthquakes() {
        ...
        try {
            ...
            //obtain the magnitude, date and location
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                //Change the format in which date and time will be displayed
                //First create a date object
                //Date dateObject=new Date(Long.parseLong(time));
                //Date dateObject=new Date(time);
                //Create a SimpleDateFormat object (a java class)
